...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0009_auto_20200806_1508'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='purchase_order_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='purchasetransaction',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='purchase_transation_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='purchasetransaction',
        ...
        migrations.AlterField(
            model_name='purchasetransaction',
            name='total_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='EGP', max_digits=14),
        ),
        migrations.AlterField(
            model_name='salesorder',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sale_order_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='salesorder',
            name='last_updated_at',
        ...
        migrations.AlterField(
            model_name='salestransaction',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sale_transaction_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='salestransaction',
            name='last_updated_at',
